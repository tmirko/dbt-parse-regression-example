...
echo "=========================================="
echo "Testing dbt-bigquery 1.9.2 parse performance"
echo "=========================================="

cd "$(dirname "$0")"

# Create/activate virtual environment and install dbt-bigquery 1.9.2
echo "Installing dbt-bigquery==1.9.2..."
rm -rf .venv
